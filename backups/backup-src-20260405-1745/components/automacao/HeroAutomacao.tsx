    ...
    <section className="relative overflow-hidden bg-sigma-light min-h-[100dvh] flex items-center justify-center pt-28 pb-16 lg:pt-20 lg:pb-16 rounded-b-[3rem] z-10 w-full">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center h-full">
          ...
          >
            <span className="text-xs md:text-sm font-bold uppercase tracking-[0.3em] text-sigma-dark/30 mb-4 block">
              Automação Comercial
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-[4.5vw] xl:text-[4rem] font-black font-display tracking-tight text-sigma-dark mb-6 leading-tight flex-1">
            ...
            <p className="text-lg md:text-xl text-sigma-dark/60 font-body leading-relaxed mb-10 max-w-xl">
